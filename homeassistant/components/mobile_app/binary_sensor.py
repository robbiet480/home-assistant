...
from .const import (ATTR_BINARY_SENSOR, ATTR_REGISTRATIONS,
                    ATTR_SENSOR_STATE, ATTR_SENSOR_TYPE_BINARY_SENSOR,
                    ATTR_SENSOR_UNIQUE_ID, CONF_WEBHOOK_ID, DOMAIN)
...
async def async_setup_platform(hass, config, async_add_entities,
    ...
    devices = hass.data[DOMAIN][ATTR_REGISTRATIONS]
    sensor_configs = hass.data[DOMAIN][ATTR_BINARY_SENSOR]
