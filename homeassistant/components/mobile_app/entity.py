...
from .const import (ATTR_REGISTRATIONS, ATTR_SENSOR_ATTRIBUTES,
                    ATTR_SENSOR_DEVICE_CLASS, ATTR_SENSOR_ICON,
                    ATTR_SENSOR_NAME, ATTR_SENSOR_TYPE, ATTR_SENSOR_UNIQUE_ID,
                    CONF_WEBHOOK_ID, DOMAIN, SIGNAL_SENSOR_UPDATE)
...
class MobileAppEntity(Entity):
    ...
    async def async_update(self):
        ...
        self._device = data[ATTR_REGISTRATIONS][self._device_id]
